  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Class Colors
        class: {
          default: "hsl(var(--class-default))",
          hero: "hsl(var(--class-hero))",
          gambler: "hsl(var(--class-gambler))",
          assassin: "hsl(var(--class-assassin))",
          wizard: "hsl(var(--class-wizard))",
          archer: "hsl(var(--class-archer))",
          tank: "hsl(var(--class-tank))",
        },
        // Priority Colors
        priority: {
